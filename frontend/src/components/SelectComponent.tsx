...
export default function SelectComponent(props: SelectComponentProps) {
    const {itemTypesArray, setItemCategory} = props
    return (
        <Select defaultValue={0}>
            {
                itemTypesArray.map((item: any, index: number) => {
                    return (
                        <Stack key={index} component='div' onClick={()=>setItemCategory(item.itemtypeid)}>
                            <Option value={index}>
