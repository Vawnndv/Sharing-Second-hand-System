    ...
    <FlatList
      ...
      renderItem={({item, index}) => (
        <CardComponent 
          key={`event${index}`}
          isShadow
          // style={[globalStyles.container, globalStyles.shadow]}
        >
          ...
          />
          <RowComponent justify='flex-end' styles={{padding: 12, backgroundColor: appColors.gray2, margin: -12, borderBottomLeftRadius: 12, borderBottomRightRadius: 12, marginTop: 8}}>
            <RowComponent>
              <Message size={18} color={'black'}/>
              <SpaceComponent width={4} />
